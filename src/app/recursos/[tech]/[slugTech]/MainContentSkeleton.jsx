function MainContentSkeleton() {
	return (
		<main className="mx-4 min-h-[calc(100vh-5rem)] w-full">
			<p className="mx-auto mt-4 w-full animate-pulse py-10 sm:w-[500px] md:w-[690px] lg:w-[600px] xl:w-[768px]">
				Debido a el uso de la versión <strong>Free</strong> de Render
				con Strapi, esta solicitud puede durar hasta 2 minutos solo la
				primera vez
			</p>
